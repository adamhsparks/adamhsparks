...
Using the [example as seen in the documentation for AUDPC](https://alvesks.github.io/epifitter/reference/AUDPC.html) from <span class="nocase">dos S. Alves and Del Ponte</span> (2021) we can calculate AUDPC using the trapezoidal method.
...
<div id="ref-dosSAlves2021" class="csl-entry">

<span class="nocase">dos S. Alves, Kaique, and Emerson M. Del Ponte</span>. 2021. *<span class="nocase">epifitter</span>: Analysis and Simulation of Plant Disease Progress Curves*. <https://CRAN.R-project.org/package=epifitter>.
