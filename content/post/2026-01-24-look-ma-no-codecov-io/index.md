...
Towards the end of my file, I have this (minus the leading ## except for the H2 "Code Coverage"):
...
Alternatively, [Pachá](https://pacha.dev/) has come up with a method for using GitHub actions and automated it even further.
See his YAML workflow file here: <https://github.com/pachadotdev/armadillo4r/blob/main/.github/workflows/test-coverage.yaml>.
His version modifies the colour of the SVG image for the badge based on the coverage level directly and does not rely on [shields.io](https://shields.io).
I should adopt this for my version.
...
My thanks to [Maëlle Salmon](https://masalmon.eu/) for copyediting this blog post for me.
