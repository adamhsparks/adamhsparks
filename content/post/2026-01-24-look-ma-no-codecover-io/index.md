...
His version modifies the colour of the SVG image for the badge based on the coverage level directly and does not rely on shields.io.
I should adopt this for my versionf
